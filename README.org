...
question and the answer, and content of the org entry is not used. If the content has Cloze syntax (={{...}}=) then both the heading and content (with new line separate) is use to create Cloze card.
